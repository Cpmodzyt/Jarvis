...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'Itzmecp;Interworld;https://i.ibb.co/5kmL7y2/file-2072.jpg',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "Interworld", "body": "ᴀᴡᴇꜱᴏᴍᴇ 🍉", "thumbnailUrl": "https://i.ibb.co/5kmL7y2/file-2072.jpg", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/t.me/itzmecp", "showAdAttribution": true}`,
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'Inter;world',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'List Menu;Interworld;https://i.ibb.co/5kmL7y2/file-2072.jpg',
  MENU_FONT: process.env.MENU_FONT || "0;0",
  SUDO: process.env.SUDO || '94773789258',
  ...
  BOT_INFO: process.env.BOT_INFO || 'Itzmecp;Interworld;https://i.ibb.co/5kmL7y2/file-2072.jpg',
